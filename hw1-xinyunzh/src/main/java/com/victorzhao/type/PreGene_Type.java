 ...
 * @generated */
public class PreGene_Type extends Annotation_Type {
  /** @generated 
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (PreGene_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = PreGene_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new PreGene(addr, PreGene_Type.this);
  			   PreGene_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new PreGene(addr, PreGene_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = PreGene.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("com.victorzhao.type.PreGene");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("Id", "com.victorzhao.type.PreGene");
  ...
  public String getSpelling(int addr) {
      ...
      jcas.throwFeatMissing("Spelling", "com.victorzhao.type.PreGene");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public PreGene_Type(JCas jcas, Type casType) {
    super(jcas, casType);
